...
class ElementsControllerTest < ActionController::TestCase
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post :create, element: { button_url: @element.button_url, category: @element.category, description: @element.description, title: @element.title }
    end
  ...
  test "should update element" do
    patch :update, id: @element, element: { button_url: @element.button_url, category: @element.category, description: @element.description, title: @element.title }
    assert_redirected_to element_path(assigns(:element))
  end
